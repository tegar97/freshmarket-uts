      ...
      <aside class="sidebar">
          <a href="#" class="sidebar-logo">
              <div class="d-flex justify-content-start align-items-center">
                  <img src="/assets/assets/img/home/icon.png" class="logo" alt="" />
                  <span>Freshmarket</span>
              </div>

              <button id="toggle-navbar" onclick="toggleNavbar()">
                  <img src="/assets/assets/img/global/navbar-times.svg" alt="" />
              </button>
          </a>

          <h5 class="sidebar-title">Product Management</h5>

          <a href="./overview" class="<?php if ($first_part == "overview") {
          ...
          <a href="/admin/product" class="<?php if ($first_part == "product") {
                                                echo "sidebar-item active";
                                            } else {
                                                echo "sidebar-item ";
                                            } ?>" onclick=" toggleActive(this)">
                  ...
                  <g fill="none" fill-rule="evenodd" id="页面-1" stroke="none" stroke-width="1">
                      <g id="导航图标" transform="translate(-325.000000, -80.000000)">
                          <g id="编组" transform="translate(325.000000, 80.000000)">
                              ...
                              <polygon id="路径" points="22 7 12 2 2 7 2 17 12 22 22 17" stroke="#ABB3C4" stroke-linejoin="round" stroke-width="1.5" />
                              <line id="路径" stroke="#ABB3C4" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" x1="2" x2="12" y1="7" y2="12" />
                              <line id="路径" stroke="#ABB3C4" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" x1="12" x2="12" y1="22" y2="12" />
                              <line id="路径" stroke="#ABB3C4" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" x1="22" x2="12" y1="7" y2="12" />
                              <line id="路径" stroke="#ABB3C4" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" x1="17" x2="7" y1="4.5" y2="9.5" />
                          </g>
                      </g>
                  </g>
              </svg>
          ...
          <a href="/admin/category" class="<?php if ($first_part == "category") {
                                    echo "sidebar-item active";
                                } else {
                                    echo "sidebar-item ";
                                } ?>" onclick=" toggleActive(this)">
